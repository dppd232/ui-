...
def template_matching(input_img, template_all, templates, save_path, top_left_points):
    ...
    visualized_path = os.path.join(save_path, "visualized_input_with_boxes.jpeg")
